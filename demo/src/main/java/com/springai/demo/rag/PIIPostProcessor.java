...
public class PIIPostProcessor implements DocumentPostProcessor {

    private static final Logger logger = LoggerFactory.getLogger(PIIPostProcessor.class);
    ...
    public static PIIPostProcessor builder() {
        return new PIIPostProcessor();
    }
}
